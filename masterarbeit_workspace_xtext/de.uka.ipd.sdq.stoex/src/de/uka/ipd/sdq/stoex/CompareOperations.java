 ...
 * <em><b>Compare Operations</b></em>', and utility methods for working with them. <!-- end-user-doc
 * -->
 *
...
public enum CompareOperations implements Enumerator {
    ...
    /**
     * The '<em><b>GREATEREQUAL</b></em>' literal object. <!-- begin-user-doc --> <!-- end-user-doc
     * -->
     *
     ...
     * <p>
     * If the meaning of '<em><b>EQUALS</b></em>' literal object isn't clear, there really should be
    ...
    /**
     * The '<em><b>NOTEQUAL</b></em>' literal value. <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>NOTEQUAL</b></em>' literal object isn't clear, there really should
     * be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The '<em><b>LESSEQUAL</b></em>' literal value. <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>LESSEQUAL</b></em>' literal object isn't clear, there really should
     * be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * The '<em><b>GREATEREQUAL</b></em>' literal value. <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>GREATEREQUAL</b></em>' literal object isn't clear, there really
    ...
    public static CompareOperations get(final String literal) {
        for (final CompareOperations result : VALUES_ARRAY) {
     ...
     * @generated
     */
    public static CompareOperations getByName(final String name) {
        for (final CompareOperations result : VALUES_ARRAY) {
    ...
    public static CompareOperations get(final int value) {
        ...
        case NOTEQUAL_VALUE:
            return NOTEQUAL;
        case LESSEQUAL_VALUE:
            return LESSEQUAL;
        case GREATEREQUAL_VALUE:
            return GREATEREQUAL;
        }
        return null;
    }
