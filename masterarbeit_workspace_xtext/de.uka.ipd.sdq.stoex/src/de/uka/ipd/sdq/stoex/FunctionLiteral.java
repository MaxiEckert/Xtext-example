...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Function Literal</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 ...
 * <li>{@link de.uka.ipd.sdq.stoex.FunctionLiteral#getParameters_FunctionLiteral <em>Parameters
 * Function Literal</em>}</li>
 * </ul>
 * </p>
 *
...
public interface FunctionLiteral extends Atom {
    ...
    /**
     * Returns the value of the '<em><b>Parameters Function Literal</b></em>' containment reference
     * list. The list contents are of type {@link de.uka.ipd.sdq.stoex.Expression}. <!--
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Parameters Function Literal</em>' containment reference list isn't
