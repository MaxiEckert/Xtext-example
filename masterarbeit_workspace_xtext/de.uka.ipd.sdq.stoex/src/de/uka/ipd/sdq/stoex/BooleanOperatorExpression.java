...
public interface BooleanOperatorExpression extends BooleanExpression {
    ...
    /**
     * Returns the value of the '<em><b>Left</b></em>' containment reference. <!-- begin-user-doc
     * -->
     * <p>
     * If the meaning of the '<em>Left</em>' containment reference isn't clear, there really should
    ...
    /**
     * Sets the value of the '{@link de.uka.ipd.sdq.stoex.BooleanOperatorExpression#getLeft
     * <em>Left</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
     ...
     * -->
     * <p>
     * If the meaning of the '<em>Right</em>' containment reference isn't clear, there really should
     * be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * 
    ...
    /**
     * Sets the value of the '{@link de.uka.ipd.sdq.stoex.BooleanOperatorExpression#getRight
     * <em>Right</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
    ...
    /**
     * Returns the value of the '<em><b>Operation</b></em>' attribute. The literals are from the
     * enumeration {@link de.uka.ipd.sdq.stoex.BooleanOperations}. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Operation</em>' attribute isn't clear, there really should be more
    ...
    /**
     * Sets the value of the '{@link de.uka.ipd.sdq.stoex.BooleanOperatorExpression#getOperation
