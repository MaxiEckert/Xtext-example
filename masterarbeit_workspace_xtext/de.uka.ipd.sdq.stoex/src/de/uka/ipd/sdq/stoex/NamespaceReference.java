...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Namespace Reference</b></em>
 * '. <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 * <li>{@link de.uka.ipd.sdq.stoex.NamespaceReference#getInnerReference_NamespaceReference <em>Inner
 * Reference Namespace Reference</em>}</li>
 * </ul>
 * </p>
 *
...
public interface NamespaceReference extends AbstractNamedReference {
    ...
    /**
     * Returns the value of the '<em><b>Inner Reference Namespace Reference</b></em>' containment
     * reference. <!-- begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Inner Reference Namespace Reference</em>' containment reference
