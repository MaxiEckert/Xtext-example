...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Negative Expression</b></em>
 * '. <!-- end-user-doc -->
 *
 * <p>
...
public interface NegativeExpression extends Unary {
    ...
    /**
     * Returns the value of the '<em><b>Inner</b></em>' containment reference. <!-- begin-user-doc
     * -->
     * <p>
     * If the meaning of the '<em>Inner</em>' containment reference list isn't clear, there really
    ...
    /**
     * Sets the value of the '{@link de.uka.ipd.sdq.stoex.NegativeExpression#getInner
     * <em>Inner</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
