...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Unit Literal</b></em>'. <!--
 * end-user-doc -->
 *
 * <p>
...
public interface UnitLiteral extends Unit {
     ...
     * begin-user-doc -->
     * <p>
     * If the meaning of the '<em>Base Unit</em>' reference isn't clear, there really should be more
    ...
    /**
     * Sets the value of the '{@link de.uka.ipd.sdq.units.UnitLiteral#getBaseUnit
     * <em>Base Unit</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @param value
