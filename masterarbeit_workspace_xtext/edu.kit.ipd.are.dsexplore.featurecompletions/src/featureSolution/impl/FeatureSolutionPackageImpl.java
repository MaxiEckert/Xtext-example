...
public class FeatureSolutionPackageImpl extends EPackageImpl implements FeatureSolutionPackage {
	 ...
	 * @generated
	 */
	public EAttribute getInternalActionPlacementStrategy_MatchingName() {
		return (EAttribute)internalActionPlacementStrategyEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getControlFlowPlacementStrategy_ControlFlow() {
		return (EAttribute)controlFlowPlacementStrategyEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(internalActionPlacementStrategyEClass, INTERNAL_ACTION_PLACEMENT_STRATEGY__MATCHING_NAME);
		...
		createEAttribute(controlFlowPlacementStrategyEClass, CONTROL_FLOW_PLACEMENT_STRATEGY__CONTROL_FLOW);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getInternalActionPlacementStrategy_MatchingName(), ecorePackage.getEString(), "matchingName", null, 0, 1, InternalActionPlacementStrategy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getControlFlowPlacementStrategy_MatchingControlFlow(), theSeffPackage.getAbstractInternalControlFlowAction(), null, "matchingControlFlow", null, 0, 1, ControlFlowPlacementStrategy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getControlFlowPlacementStrategy_ControlFlow(), this.getControlFlow(), "controlFlow", "LOOP", 0, 1, ControlFlowPlacementStrategy.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
