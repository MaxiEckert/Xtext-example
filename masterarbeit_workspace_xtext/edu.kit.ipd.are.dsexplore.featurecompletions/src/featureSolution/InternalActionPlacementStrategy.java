 ...
 *   <li>{@link featureSolution.InternalActionPlacementStrategy#getMatchingName <em>Matching Name</em>}</li>
 * </ul>
 *
...
public interface InternalActionPlacementStrategy extends PlacementStrategy {
	...
	/**
	 * Returns the value of the '<em><b>Matching Name</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Matching Name</em>' attribute isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Matching Name</em>' attribute.
	 * @see #setMatchingName(String)
	 * @see featureSolution.FeatureSolutionPackage#getInternalActionPlacementStrategy_MatchingName()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link featureSolution.InternalActionPlacementStrategy#getMatchingName <em>Matching Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Matching Name</em>' attribute.
	 * @see #getMatchingName()
	 * @generated
	 */
	void setMatchingName(String value);
